...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        greetImg = findViewById(R.id.ivGreeting)
        greetText = findViewById(R.id.tvGreeting)
            ...
            val task = ClientAsyncTask(this, object : ClientAsyncTask.OnPostExecuteListener {
                override fun onPostExecute(result: String) {
                    ...
                    try {
                        ...
                        tvDate.text = obData.getString("tanggal")
                        tvSubuh.text = obData.getString("subuh")
                        tvDzuhur.text = obData.getString("dzuhur")
                        tvAshar.text = obData.getString("ashar")
                        tvMaghrib.text = obData.getString("maghrib")
                        tvIsya.text = obData.getString("isya")
